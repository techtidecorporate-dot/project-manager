    ...
    return (
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-[#191a23]">Welcome back, Future Corp!</h1>
                    <p className="text-gray-500 mt-1">Here's what's happening with your projects today.</p>
                </div>
                <button className="px-6 py-3 bg-[#453abc] text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-8 rounded-[32px] shadow-lg border border-gray-200">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-xl font-bold text-[#191a23]">Current Project Status</h2>
                        <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-bold">Active</span>
                    </div>

                    <div className="mb-6">
                        <h3 className="text-2xl font-bold text-[#191a23] mb-2">{activeProject.name}</h3>
                        <p className="text-gray-500 text-sm">Next Milestone: <span className="font-bold text-[#453abc]">{activeProject.nextMilestone}</span></p>
                    </div>
                    ...
                    <div className="space-y-2 mb-8">
                        ...
                        <div className="w-full bg-gray-100 h-3 rounded-full overflow-hidden">
                            <div className="bg-[#453abc] h-full rounded-full transition-all duration-1000" style={{ width: `${activeProject.progress}%` }}></div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                            ...
                            <p className="font-bold text-[#191a23]">Development</p>
                        </div>
                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                            <p className="text-xs text-gray-400 uppercase font-bold">Estimated Delivery</p>
                            <p className="font-bold text-[#191a23]">Dec 20, 2023</p>
                        </div>
                    </div>
                </div>

                {/* Notifications / Recent Activity */}
                <div className="bg-[#191a23] p-8 rounded-[32px] shadow-lg text-[#ffffff]">
                    <h2 className="text-xl font-bold mb-6 flex items-center gap-2">
                        <Clock size={20} className="text-[#453abc]" />
                        Recent Updates
                    </h2>
                        ...
                        {[
                            ...
                            <div key={i} className="flex gap-4 group cursor-pointer">
                                <div className="flex flex-col items-center">
                                    <div className="w-2 h-2 rounded-full bg-[#453abc]"></div>
                                    <div className="w-0.5 h-full bg-[#453abc]/20 my-1 group-last:hidden"></div>
                                </div>
                                <div>
                                    <p className="text-xs text-[#453abc] font-bold uppercase tracking-wider mb-1">{item.type} â€¢ {item.time}</p>
                    ...
                    <button className="mt-8 w-full py-4 rounded-xl border border-[#453abc]/30 hover:bg-[#453abc]/10 transition-colors text-sm font-bold flex items-center justify-center gap-2">
