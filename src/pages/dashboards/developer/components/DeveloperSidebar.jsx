...
const DeveloperSidebar = ({ isOpen, onClose }) => {
    ...
    const navItems = [
        ...
        { icon: FolderKanban, label: 'My Projects', path: '/developer/projects' },
        { icon: ClipboardList, label: 'Assigned Tasks', path: '/developer/tasks' },
        { icon: Zap, label: 'Request Session', path: '/developer/requests' },
        { icon: CheckCircle2, label: 'Completed Tasks', path: '/developer/completed' },
        { icon: Trophy, label: 'My Score', path: '/developer/score' },
