...
const DeveloperOverview = () => {
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-bold text-[#191a23]">Developer Dashboard</h1>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
                <h2 className="text-xl font-bold text-[#191a23] mb-6">Current Tasks</h2>
                    ...
                    {[1, 2].map((i) => (
                        <div key={i} className="p-4 border border-gray-100 rounded-xl hover:border-gray-200 transition-colors bg-gray-50/50">
                            <div className="flex justify-between items-start mb-2">
                                <h3 className="font-bold text-[#191a23]">Implement Dashboard Feature</h3>
