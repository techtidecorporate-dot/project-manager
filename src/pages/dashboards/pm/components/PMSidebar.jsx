...
const PMSidebar = ({ isOpen, onClose }) => {
    ...
    const navItems = [
        ...
        { icon: Globe, label: 'Departments', path: '/pm/departments' },
        { icon: Flag, label: 'Milestones', path: '/pm/milestones' },
        { icon: Clock, label: 'Timeline', path: '/pm/timeline' },
        { icon: CheckSquare, label: 'Tasks', path: '/pm/tasks' },
        { icon: Users, label: 'Division', path: '/pm/division' },
        { icon: FileText, label: 'Requests', path: '/pm/requests' },
        { icon: Settings, label: 'Settings', path: '/pm/settings' }
    ];
